defmodule Batcher.Clients.OpenAI.ApiClient do
  @moduledoc """
  Client wrapper for OpenAI file and batch endpoints.
  """
  require Logger
  ...
  @doc """
  Extracts token usage totals from an OpenAI batch status response.
  """
  ...
  defp base_url() do
    default =
      Application.get_env(:batcher, __MODULE__, [])[:base_url] ||
