defmodule Batcher.Repo.Migrations.CapacityAwareAdmissionV2 do
  @moduledoc """
  ...
  def up do
    ...
    execute("""
    UPDATE requests
    SET estimated_input_tokens = CAST((((LENGTH(request_payload) / 3.5) * 1.10) + 0.9999) AS INTEGER)
    WHERE estimated_input_tokens = 0
    """)
